...
class LimitHandler(private val emailRepository: OutboxEmailRepository) {
    companion object {
        const val MAX_EMAILS_PER_HOUR = 5   // Actually 3000, but use a 5 % buffer to avoid hitting the limit

        // 10 every 10 seconds = max 3600 per hour
        const val PENDING_EMAIL_BATCH_SIZE = 3
        ...
        const val RETRY_EMAIL_BATCH_SIZE = 3
